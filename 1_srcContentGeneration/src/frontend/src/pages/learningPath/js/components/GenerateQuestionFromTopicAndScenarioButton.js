...
import sampleData from '../data/sampleGenerateQuestionFromTopicAndScenario.json' assert { type: "json" };
...
export class GenerateQuestionFromTopicAndScenarioButton {
    ...
    async _handleClick(e) {
        ...
        try {
            // Luôn sử dụng sample data cho testing
            console.log('Using sample data for testing');
            const data = typeof sampleData.chunkingPhrases === 'string' 
                ? JSON.parse(sampleData.chunkingPhrases)
                : sampleData.chunkingPhrases;
